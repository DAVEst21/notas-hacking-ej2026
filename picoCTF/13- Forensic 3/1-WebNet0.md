...
### Notas adicionales
**TLS** son las siglas de **Transport Layer Security** (Seguridad de la Capa de Transporte). Es un protocolo criptográfico diseñado para proporcionar **seguridad y privacidad** en las comunicaciones a través de una red, principalmente Internet.

En términos sencillos, es la tecnología que permite que la información que viaja entre tu dispositivo (ordenador, móvil) y un servidor (como el de un banco, una red social o una tienda online) vaya **encriptada y sea privada**.
