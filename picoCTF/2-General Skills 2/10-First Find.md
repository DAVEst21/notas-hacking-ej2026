...
#### Solución 1
```
DAVEst-picoctf@webshell:~$ wget https://artifacts.picoctf.net/c/501/files.zip
--2026-02-11 15:11:50--  https://artifacts.picoctf.net/c/501/files.zip
...
2026-02-11 15:11:52 (1.81 MB/s) - 'files.zip' saved [3995553/3995553]

DAVEst-picoctf@webshell:~$ unzip files.zip 
Archive:  files.zip
   creating: files/
...
files  files.zip
DAVEst-picoctf@webshell:~$ cd files/
DAVEst-picoctf@webshell:~/files$ grep -r pico
